...
DATASET_NAME = 'house'
RESULTS_DIR  = f'results_{DATASET_NAME}_3d_v3'
DATA_DIR     = '../data'

def load_dataset():
    df = pd.read_csv(Path(DATA_DIR) / 'feldman' / 'house.csv')
    targets = ['lat', 'price','sqft_living15']
...
def main():
    ...
    outfile = os.path.join(RESULTS_DIR, f'seed_{seed:04d}_{model_name}_3d.json')
